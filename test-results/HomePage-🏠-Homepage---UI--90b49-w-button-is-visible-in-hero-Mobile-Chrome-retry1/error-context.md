...
- Name: HomePage.spec.js >> 🏠 Homepage - UI & Content >> TC06 - Book Now button is visible in hero
- Location: tests\HomePage.spec.js:40:3
...
Locator: locator('a').filter({ hasText: 'Book Now' })
Expected: visible
Timeout: 5000ms
