...
- Name: navigation.spec.js >> 🔗 Navigation >> TC21 - Clicking Contact nav goes to /contact
...
Call log:
  - waiting for locator('nav a').filter({ hasText: 'Contact' })
    - locator resolved to <a href="/contact" class="text-[11px] font-medium text-zinc-600 transition-colors hover:text-zinc-900">Contact</a>
      ...
      - main [ref=e11]:
        - generic [ref=e15]:
          - generic [ref=e16]:
            ...
            - heading "Premium EV" [level=1] [ref=e24]:
              - generic [ref=e25]: Premium EV
