...
- Name: navigation.spec.js >> 🔗 Navigation >> TC20 - Clicking About nav goes to /about
- Location: tests\navigation.spec.js:17:3
...
Call log:
  - waiting for locator('nav a').filter({ hasText: 'About' })
    - locator resolved to <a href="/about" class="text-[11px] font-medium text-zinc-600 transition-colors hover:text-zinc-900">About</a>
      ...
      - main [ref=e11]:
        - generic [ref=e15]:
          - generic [ref=e16]:
            ...
            - heading "Premium EV S" [level=1] [ref=e24]:
              - generic [ref=e25]: Premium EV S
