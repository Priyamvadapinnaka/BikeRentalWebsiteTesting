...
- Name: HomePage.spec.js >> 🏠 Homepage - UI & Content >> TC08 - Hourly price is ₹35
- Location: tests\HomePage.spec.js:51:3
...
Locator: locator('text=₹35')
Expected: visible
Error: strict mode violation: locator('text=₹35') resolved to 10 elements:
    1) <p class="mt-4 text-[11px] sm:text-xs md:text-sm lg:text-[15px] text-zinc-400 drop-shadow-lg max-w-[320px] md:max-w-md leading-relaxed opacity-95 font-medium">…</p> aka locator('section').filter({ hasText: 'Premium MobilityRent from our' }).getByRole('paragraph')
    2) <p class="text-[11px] md:text-xs text-muted-foreground leading-relaxed">Premium rides that fit your budget, starting as l…</p> aka getByText('Premium rides that fit your')
    3) <span class="text-3xl font-bold text-white">₹35</span> aka getByText('₹').nth(4)
    4) <span class="text-xs font-medium text-zinc-200">₹35</span> aka getByText('₹35').nth(3)
    5) <div class="font-semibold text-xs">…</div> aka getByText('₹35/hr').nth(1)
    6) <div class="font-semibold text-xs">…</div> aka getByText('₹35/hr').nth(2)
    7) <div class="font-semibold text-xs">…</div> aka getByText('₹35/hr').nth(3)
    8) <div class="font-semibold text-xs">…</div> aka getByText('₹35/hr').nth(4)
    9) <div class="font-semibold text-xs">…</div> aka getByText('₹35/hr').nth(5)
    10) <p class="text-black/70 text-xs max-w-xs leading-relaxed">…</p> aka getByText('Rent from our fleet of 15+ premium electric scooters in Hyderabad from ₹35/hr.', { exact: true })

Call log:
  - Expect "toBeVisible" with timeout 5000ms
  - waiting for locator('text=₹35')
      ...
      - main [ref=e11]:
        - generic [ref=e15]:
          - generic [ref=e16]:
            ...
            - heading "Premium EV Scooter Renta" [level=1] [ref=e24]:
              - generic [ref=e25]: Premium EV Scooter Renta
